...
class AddIncomeActivity : AppCompatActivity() {
    ...
    private fun setupSpinner() {
        val incomeCategories = arrayOf("Salary", "Bonus", "Gift", "Other Income")
        val adapter = ArrayAdapter(this, R.layout.spinner_item, incomeCategories)
    ...
    private fun loadTransactionData() {
        ...
        if (transaction.type != "Income") {
            Toast.makeText(this, "Cannot edit an expense as income", Toast.LENGTH_SHORT).show()
            finish()
            return
        }
        ...
        btnSaveIncome.text = "Update Income"
    }
    ...
    private fun saveIncome() {
        ...
        saveData()
        Toast.makeText(this, if (isEditing) "Income updated" else "Income added", Toast.LENGTH_SHORT).show()
        finish()
    }
